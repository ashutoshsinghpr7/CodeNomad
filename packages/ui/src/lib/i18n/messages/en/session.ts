export const sessionMessages = {
  ...
  "sessionList.actions.move.ariaLabel": "Move session to folder",
  "sessionList.actions.move.title": "Move to folder",
  "sessionList.move.error": "Unable to move session",
  "sessionList.move.success": "Session moved to {path}",
  "sessionList.move.title": "Move Session",
  "sessionList.move.description": "Move \"{label}\" to a different project folder. The session's conversation history will be preserved.",
  "sessionList.move.inputLabel": "Target folder path",
  "sessionList.move.inputPlaceholder": "/path/to/project/folder",
  "sessionList.move.confirmLabel": "Move",
  "sessionList.move.cancelLabel": "Cancel",
  "sessionList.move.moving": "Moving…",
